...
logLik.gllvm.quadratic <- function(object, ...) {
    ...
    if(object$family=="ordinal"&object$zeta.struc=="species")object$params$zeta<-object$params$zeta[,-1]
    if(object$family=="ordinal"&object$zeta.struc=="common")object$params$zeta<-object$params$zeta[-1]
