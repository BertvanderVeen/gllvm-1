...
gllvm.quadratic <- function(y = NULL, X = NULL, TR = NULL, data = NULL, formula = NULL, num.lv = 2, family, row.eff = FALSE, offset = NULL, 
    ...
    start.fit = NULL, starting.val = "lingllvm", optimizer = "optim", Lambda.start = c(0.1, 0.5), jitter.var = 0.2, ridge = FALSE, 
    ridge.quadratic = FALSE, start.method="FA",par.scale=1, fn.scale=1, grad.check = FALSE, zeta.struc="species", starting.val.lingllvm = "res", single.curve = FALSE, parallel=FALSE, opt=1, start.opt="common") {
